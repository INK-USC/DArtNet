...
def test(args):
    ...
    # model.entity_s_his_test = checkpoint['entity_s_his_test']
    # model.rel_s_his_test = checkpoint['rel_s_his_test']
    # model.att_s_his_test = checkpoint['att_s_his_test']
    # model.self_att_s_his_test = checkpoint['self_att_s_his_test']
    # model.entity_o_his_test = checkpoint['entity_o_his_test']
    # model.rel_o_his_test = checkpoint['rel_o_his_test']
    # model.att_o_his_test = checkpoint['att_o_his_test']
    # model.self_att_o_his_test = checkpoint['self_att_o_his_test']
    # model.entity_s_his_cache = checkpoint['entity_s_his_cache']
    # model.rel_s_his_cache = checkpoint['rel_s_his_cache']
    # model.att_s_his_cache = checkpoint['att_s_his_cache']
    # model.self_att_s_his_cache = checkpoint['self_att_s_his_cache']
    # model.entity_o_his_cache = checkpoint['entity_o_his_cache']
    # model.rel_o_his_cache = checkpoint['rel_o_his_cache']
    # model.att_o_his_cache = checkpoint['att_o_his_cache']
    # model.self_att_o_his_cache = checkpoint['self_att_o_his_cache']
