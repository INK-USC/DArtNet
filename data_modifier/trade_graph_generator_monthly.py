...
SAVE_PATH = '/home/sankalp/tkg/data/trade-data-graph-monthly'
...
graph_data = final_conversion_of_data(graph_data)
...
with open('{}/stat.txt'.format(SAVE_PATH), 'w') as f:
    f.write(f'{len(final_countries)}\t{int(2*num_relations)}')
